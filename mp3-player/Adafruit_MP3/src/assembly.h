...
// https://community.arm.com/processors/f/discussions/6636/how-to-get-absolute-value-of-a-32-bit-signed-integer-as-fast-as-possible
static inline int FASTABS(int parVal)
{
    int wResult;
